...
overall_batsman_details = pd.DataFrame(columns=['team','innings','runs','balls', 'average', 'strike_rate','fifties','centuries','zeros'])
match_batsman_details = pd.DataFrame(columns=['date','name','team','opposition','runs','balls','not_out','venue','batting_innings','outcome','strike_rate'])
...
for filename in os.listdir('odis'):
    if filename.endswith('.yaml'):
        ...
        for player in player_details.index:
            ...
            overall_batsman_details.loc[player,'strike_rate'] += (player_details.loc[player,'runs']/player_details.loc[player,'balls'])*100
            ...
            match_batsman_details.loc[count,'strike_rate'] = (player_details.loc[player,'runs']/player_details.loc[player,'balls'])*100
